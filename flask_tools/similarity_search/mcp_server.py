...
import click
from flask_tools.similarity_search import ChemformerEmbedder, FaissDataRetriever
...
forward_embedder: ChemformerEmbedder = None
retro_embedder: ChemformerEmbedder = None
